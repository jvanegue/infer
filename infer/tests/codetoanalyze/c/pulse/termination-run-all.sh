...
# Eternal!
#time $ROOT/infer/bin/infer run --pulse-only --pulse-eternal --enable-issue-type INFINITE_LOOP --enable-issue-type INFINITE_RECURSION --pulse-widen-threshold 20 -- clang -c infinite.c 2> infer-run.log
time $ROOT/infer/bin/infer run --pulse-only --pulse-eternal --enable-issue-type INFINITE_LOOP --enable-issue-type INFINITE_RECURSION --pulse-widen-threshold 20 -- clang -c infinite2.c 2> infer-run.log
