...
rm -fr infer-out/ infinite.o *~ infer-run-pcre2.log

# executing the saved github tree
make clean
time /huge/jvanegue/PUBLIC_GITHUB/infer/infer/bin/infer run --pulse-widen-threshold 20 --pulse-only -- make -j30 2> infer-run-pcre2.log
