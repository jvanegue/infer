...
rm -fr infer-out/ infinite.o *~ infer-run-libxpm.log

# executing the saved github tree
time /huge/jvanegue/PUBLIC_GITHUB/infer/infer/bin/infer run --pulse-only --debug-level 0 -- make -j30 2> infer-run-libxpm.log
