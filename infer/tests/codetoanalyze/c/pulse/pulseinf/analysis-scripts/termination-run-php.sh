...
rm -fr infer-out/ infinite.o *~ infer-run-php.log
...
#make clean
time /huge/jvanegue/PUBLIC_GITHUB/infer/infer/bin/infer run --pulse-only --debug-level 0 --keep-going -- make -j30 2> infer-run-php.log
